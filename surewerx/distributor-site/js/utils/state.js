...
var AppState = {
  ...
  initializeData: function() {
    ...
    this.transactions = [
      { id: 't1', orderId: 'ORD-2024-001', employeeName: 'John Smith', employeeEmail: 'john.smith@boeing.com', employeeGroup: 'Safety Team', customerName: 'Boeing', productName: 'Safety Glasses - Clear Lens', surewerxPartNumber: 'SWX-SG-001', distributorPartNumber: '', quantity: 2, unitPrice: 15.99, totalPrice: 31.98, distributorCost: 12.00, dateOrdered: '2024-11-01', voucherUsed: 'Monthly Safety Allowance', voucherAmount: 150.00, lineStatus: 'Shipped', paymentMethod: 'Voucher', actualCreditCardRefund: 0, shippingCarrier: 'UPS', shippingMethod: 'Ground' },
      { id: 't2', orderId: 'ORD-2024-001', employeeName: 'John Smith', employeeEmail: 'john.smith@boeing.com', employeeGroup: 'Safety Team', customerName: 'Boeing', productName: 'Hard Hat - Yellow', surewerxPartNumber: 'SWX-HH-002', distributorPartNumber: '', quantity: 1, unitPrice: 24.99, totalPrice: 24.99, distributorCost: 18.50, dateOrdered: '2024-11-01', voucherUsed: 'Monthly Safety Allowance', voucherAmount: 150.00, lineStatus: 'Shipped', paymentMethod: 'Voucher', actualCreditCardRefund: 0, shippingCarrier: 'UPS', shippingMethod: 'Ground' },
      { id: 't3', orderId: 'ORD-2024-002', employeeName: 'Sarah Johnson', employeeEmail: 'sarah.johnson@boeing.com', employeeGroup: 'Safety Team', customerName: 'Boeing', productName: 'Work Gloves - Leather', surewerxPartNumber: 'SWX-GL-003', distributorPartNumber: '', quantity: 3, unitPrice: 12.99, totalPrice: 38.97, distributorCost: 9.00, dateOrdered: '2024-10-28', voucherUsed: 'Monthly Safety Allowance', voucherAmount: 150.00, lineStatus: 'Shipped', paymentMethod: 'Voucher', actualCreditCardRefund: 15.50, shippingCarrier: 'FedEx', shippingMethod: 'Express' },
      { id: 't4', orderId: 'ORD-2024-002', employeeName: 'Sarah Johnson', employeeEmail: 'sarah.johnson@boeing.com', employeeGroup: 'Safety Team', customerName: 'Boeing', productName: 'Safety Vest - Hi-Vis Orange', surewerxPartNumber: 'SWX-SV-004', distributorPartNumber: '', quantity: 2, unitPrice: 19.99, totalPrice: 39.98, distributorCost: 14.00, dateOrdered: '2024-10-28', voucherUsed: 'Quarterly PPE Budget', voucherAmount: 300.00, lineStatus: 'Shipped', paymentMethod: 'Voucher', actualCreditCardRefund: 15.50, shippingCarrier: 'FedEx', shippingMethod: 'Express' },
      { id: 't5', orderId: 'ORD-2024-003', employeeName: 'John Smith', employeeEmail: 'john.smith@boeing.com', employeeGroup: 'Safety Team', customerName: 'Boeing', productName: 'Steel Toe Boots - 6 inch', surewerxPartNumber: 'SWX-ST-001', distributorPartNumber: '', quantity: 1, unitPrice: 89.99, totalPrice: 89.99, distributorCost: 68.00, dateOrdered: '2024-10-15', voucherUsed: 'Monthly Safety Allowance', voucherAmount: 150.00, lineStatus: 'Shipped', paymentMethod: 'Voucher', actualCreditCardRefund: 39.99, shippingCarrier: 'USPS', shippingMethod: 'Priority Mail' },
